...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: Globe,
    skills: ["Next.js", "React", "Express.js", "Flutter", "Bootstrap", "Tailwind CSS", "Node.js"],
    color: "teal",
  ...
  },
  {
    ...
    title: "Databases",
    icon: Database,
    skills: ["MongoDB", "Firebase", "MySQL", "Real-time Databases", "PostgreSQL"],
    color: "cyan",
  ...
  },
  {
    ...
    title: "Backend & APIs",
    icon: Server,
    skills: ["RESTful APIs", "GraphQL", "Server-side Development", "Authentication", "Microservices"],
    color: "orange",
  ...
  },
  {
    ...
    icon: Tool,
    skills: ["Git", "VS Code", "Figma", "Chrome DevTools", "Postman", "Docker", "Vercel"],
    color: "rose",
